        ...
        <div className={_.footer__content}>
          ...
          <address className={_.footer__address}>
            <div className={_.footer__contact}>
              ...
              <a className={_.footer__phone} href="tel:+79628585284">
                <svg
                  width="24"
                  height="24"
                  viewBox="0 0 24 24"
          ...
          <div className={_.footer__development}>
            <p>© YourMeal, 2023</p>
            <p>
              Design: <a href="#"> McDonalds & YandexEda </a>
            </p>
            <p>
              Developer: <a href="Bruce-99@mail.ru">Nerukh Vladislav & Fomenko Tamerlan</a>
            </p>
          </div>
        </div>
      </Container>
